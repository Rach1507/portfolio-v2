    ...
    <div className="">
      <div className="fixed left-14 flex flex-col w-6 justify-end items-center gap-9 bottom-0">
        <a
          ...
          className="text-slate-400 w-9 h-9 hover:text-slate-50 hover:animate-bounce"
          aria-label="GitHub"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          ...
          aria-label="Leetcode"
          target="_blank"
          className="text-slate-400 w-8 h-8 hover:text-slate-50 text-shadow hover:animate-bounce"
          rel="noreferrer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          ...
          aria-label="Linkedin"
          target="_blank"
          className="text-slate-400 w-8 h-8  hover:text-slate-50 hover:animate-bounce"
          rel="noreferrer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="border border-solid border-sky-500 h-20"></div>
      </div>
    </div>
  );
};
