export const synamediaRoleInfo = {
  ...
  techStack: [
    {
      ...
      icon: (
        <svg
          ...
          x="0px"
          y="0px"
          className="fill-sky-300 h-4 md:h-8"
          // width="100"
          // height="100"
          viewBox="0 0 48 48"
        >
    ...
    },
    {
      name:"Jest",
      icon :  ( 
         <svg viewBox="0 0 24 24" className="fill-sky-300 h-3 md:h-7"> 
    ...
    //   name: "Pytest",
    //   icon: (
    //     <svg xmlns="http://www.w3.org/2000/svg" className="fill-sky-300">
    //       <path d="m47.2890472 47.8176079v-47.8176079h80.312355v47.8176079zm305.9854889 0v-47.8176079h-80.3123779v47.8176079zm-112.836502 0v-47.8176079h-80.3125v47.8176079zm249.0438995 15.2878303h-466.9022369c-30.1062622.0000305-30.1062622 45.0886841 0 45.0886536h466.9022217c30.0241241 0 30.0241241-45.0886536.0000152-45.0886536zm-23.3707886-15.2878303v-47.8176079h-80.3123474v47.8176079zm-80.3123474 75.6643104v117.1345367h80.3123474v-117.1345367zm-112.8366394 0v201.8516083h80.3123779v-201.8516083zm-112.8366241 0v311.2155762h80.3125v-311.2155762zm-112.8364869 0v388.5180817h80.312355v-388.5180817z" />
    //     </svg>
    //   ),
    // },
  ],
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <path d="M24.46,49.79l12,20.72a2,2,0,0,0,3.46-2l-12-20.71a11.68,11.68,0,0,0,4-6.8H56a2,2,0,0,0,0-4H32a11.67,11.67,0,1,0-7.51,12.79Zm-4-18.63a7.68,7.68,0,1,1-7.68,7.68A7.69,7.69,0,0,1,20.45,31.16Z" />
          <path d="M107.55,77.48a11.66,11.66,0,0,0-9,4.3l-19.62-12A16,16,0,0,0,66,48.14v-23a11.68,11.68,0,1,0-4,0v23A16,16,0,0,0,49.11,69.81l-19.62,12a11.68,11.68,0,1,0,2,3.49L51,73.33a15.95,15.95,0,0,0,25.95,0L96.55,85.27a11.67,11.67,0,1,0,11-7.79ZM20.45,96.84a7.68,7.68,0,1,1,7.68-7.68A7.69,7.69,0,0,1,20.45,96.84ZM56.32,13.68A7.68,7.68,0,1,1,64,21.35,7.69,7.69,0,0,1,56.32,13.68ZM64,76A12,12,0,1,1,76,64,12,12,0,0,1,64,76Zm43.55,20.84a7.68,7.68,0,1,1,7.68-7.68A7.69,7.69,0,0,1,107.55,96.84Z" />
          <path d="M83,81.86a2,2,0,0,0-2.74.71L68,103.37a11.46,11.46,0,0,0-8,0l-12.13-21a2,2,0,0,0-3.46,2l12.13,21a11.68,11.68,0,1,0,15,0L83.72,84.6A2,2,0,0,0,83,81.86ZM64,122a7.68,7.68,0,1,1,7.68-7.68A7.69,7.69,0,0,1,64,122Z" />
          <path d="M72.08,37a2,2,0,0,0,0,4h24a11.68,11.68,0,0,0,4,6.82l-11.7,21a2,2,0,0,0,.77,2.72,2,2,0,0,0,2.72-.77L103.56,49.8A11.67,11.67,0,1,0,96,37Zm35.47-5.84a7.68,7.68,0,1,1-7.68,7.68A7.69,7.69,0,0,1,107.55,31.16Z" />
          <text
            x="0"
            y="143"
            fill="#000000"
      ...
      icon: (
        ...
        >
          ...
          <rect
            ...
            y="69.785"
            // fill="#68dbaf"
            transform="rotate(-44.749 85.27 84.703)"
          ></rect>
          <g>
            <path
              // fill="#239198"
              d="M94.567,105.935l17.419,17.584c3.277,3.308,8.451,3.308,11.556,0l0,0c3.277-3.308,3.277-8.532,0-11.666
						l-17.419-17.584c-3.105-3.134-8.279-3.308-11.556,0l0,0C91.463,97.403,91.29,102.801,94.567,105.935z"
            ></path>
          </g>
          <g>
            <path
              fill="#fff"
              d="M71.596,40.726h-4.172c-0.58-3.55-1.929-6.827-3.883-9.647l2.909-2.949c1.497-1.517,1.497-3.975,0-5.493
						c-1.497-1.517-3.921-1.517-5.418,0l-2.872,2.912c-2.785-2.043-6.03-3.457-9.552-4.062V17.42c0-2.145-1.716-3.884-3.832-3.884
						s-3.832,1.739-3.832,3.884v4.067c-3.522,0.605-6.768,2.019-9.552,4.062l-2.872-2.912c-1.497-1.517-3.921-1.517-5.418,0
						s-1.497,3.975,0,5.493l2.909,2.949c-1.954,2.82-3.303,6.097-3.883,9.647h-4.172c-2.116,0-3.832,1.739-3.832,3.884
						s1.716,3.884,3.832,3.884h4.172c0.58,3.55,1.929,6.827,3.883,9.647L23.1,61.09c-1.497,1.517-1.497,3.975,0,5.493
						c0.748,0.759,1.729,1.138,2.709,1.138s1.961-0.379,2.709-1.138l2.872-2.912c2.785,2.042,6.03,3.457,9.552,4.062V71.8
						c0,2.145,1.716,3.884,3.832,3.884s3.832-1.739,3.832-3.884v-4.068c3.522-0.605,6.768-2.019,9.552-4.062l2.872,2.912
						c0.748,0.759,1.729,1.138,2.709,1.138c0.98,0,1.961-0.379,2.709-1.138c1.497-1.517,1.497-3.975,0-5.493l-2.909-2.949
						c1.954-2.82,3.303-6.097,3.883-9.647h4.172c2.116,0,3.832-1.739,3.832-3.884C75.428,42.465,73.712,40.726,71.596,40.726z"
            ></path>
            <ellipse
              cx="44.775"
              cy="44.61"
          ...
          <g>
            <polygon
              // fill="#d94635"
              points="109.218 27.091 113.098 29.213 109.218 31.334 107.097 35.213 104.975 31.334 101.095 29.213 104.975 27.091 107.097 23.213"
            ></polygon>
            <polygon
              // fill="#239198"
              points="32.539 105.505 36.418 107.627 32.539 109.748 30.417 113.627 28.295 109.748 24.415 107.627 28.295 105.505 30.417 101.627"
            ></polygon>
          </g>
        </svg>
      ),
